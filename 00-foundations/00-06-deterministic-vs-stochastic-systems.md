...
For deeper treatment of **deterministic assessment**, see [deterministic assessment](../06-kernel/06-08-deterministic-assessment.md). For **validation** and **evidence**, see [validation](../06-kernel/06-03-validation.md) and [runtime evidence](../06-kernel/06-06-runtime-evidence.md). For **machine-readable intent** and autonomy in the integrated STE story, see [What STE is and is not](00-07-what-ste-is-and-is-not.md) and [The STE thesis](00-08-the-ste-thesis.md).
