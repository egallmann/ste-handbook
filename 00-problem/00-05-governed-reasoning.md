...
STE connects **intent**, **Architecture IR**, **validation**, **evidence**, and **governance** into a loop meant to support **governed reasoning** end to end. For assessment mechanics, see [validation](../07-kernel/07-03-validation.md) and [deterministic assessment](../07-kernel/07-07-deterministic-assessment.md). For **governance** in the lifecycle, see [governance](../06-governance/06-06-governance.md). For the control loop narrative, see [control loop overview](../06-governance/06-07-control-loop-overview.md).
