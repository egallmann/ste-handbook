...
For deeper treatment of **deterministic decisions** and **fail-closed** behavior, see [Determinism and fail-closed](../07-kernel/07-06-determinism-and-fail-closed.md). For **validation** and **evidence**, see [Kernel reasoning surface](../07-kernel/07-05-kernel-reasoning-surface.md) and [Part 8: Runtime Overview](../08-runtime/08-00-runtime-overview.md). For **machine-readable intent** and autonomy in the integrated STE story, see [What STE is and is not](00-07-what-ste-is-and-is-not.md) and [The STE thesis](00-08-the-ste-thesis.md).
