...
For the artifact layer and how **ADRs** fit, see [Part 3: Artifact layer overview](../03-artifacts/03-00-artifact-layer-overview.md) and [Architecture decision records](../03-artifacts/03-01-architecture-decision-records.md). For how **conformance** is assessed, see [Kernel reasoning surface](../07-kernel/07-05-kernel-reasoning-surface.md). For the canonical structural compilation of intent, see [Architecture model (Architecture IR) overview](../04-architecture-model/04-00-architecture-ir-overview.md). For mismatch over time and the closed loop, see [The governance model](../06-governance/06-02-the-governance-model.md). For authority, admission, and enforcement posture on that loop, see [Section overview (Part 6)](../06-governance/06-00-section-overview.md).
