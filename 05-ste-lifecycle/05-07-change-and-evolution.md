...
Revised **intent** artifacts, updated **Architecture IR**, new or modified **implementation** artifacts, refreshed **trace** links, and new **evidence** after **change** lands. See [Change management](../10-lifecycle-governance/10-02-change-management.md) and [Diff and change](../04-architecture-ir/04-06-diff-and-change.md).
