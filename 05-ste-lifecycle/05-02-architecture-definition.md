...
**Architecture IR**, structural elements and relationships, and **projections** derived from the canonical model. **Traceability** links connect **intent** artifacts to model elements. See [Architecture model and IR](../03-artifact-layer/03-04-architecture-model-and-ir.md), [Traceability](../03-artifact-layer/03-06-traceability.md), [Publication versus projection](../03-artifact-layer/03-08-publication-vs-projection.md), and Part 4 ([Architecture IR overview](../04-architecture-ir/04-00-architecture-ir-overview.md)).
