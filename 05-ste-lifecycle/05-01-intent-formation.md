...
Primary **intent** artifacts: **ADRs**, requirements, **constraints**, and **invariants**. Supporting material may compile toward **Architecture IR** once structure is stable enough to model. See [Architecture decision records](../03-artifact-layer/03-01-architecture-decision-records.md), [Requirements and constraints](../03-artifact-layer/03-02-requirements-and-constraints.md), [Invariants](../03-artifact-layer/03-03-invariants.md), and [Architecture model and IR](../03-artifact-layer/03-04-architecture-model-and-ir.md).
