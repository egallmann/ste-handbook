...
Decision records (often **ADR**-shaped updates or addenda), approval artifacts, **exception** packages with **scope** and expiry where policy requires, lifecycle state transitions, and links to the **evidence** and **conformance** records that justified the call. See [Governance](../10-lifecycle-governance/10-06-governance.md) and [Certification](../10-lifecycle-governance/10-05-certification.md).
