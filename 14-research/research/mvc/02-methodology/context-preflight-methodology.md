...
Context preflight is part of MVC research methodology. It connects to [MVC methodology](mvc-methodology.md), [MVC experimental design](../03-experiment-design/mvc-experimental-design.md), [Evidence and Reproducibility](../../../14-06-evidence-and-reproducibility.md), and [MVC open questions](../06-open-questions.md).
