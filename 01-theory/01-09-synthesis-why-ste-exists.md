...
- **Projections** (Part 4), including architecture **views** derived from the same **Architecture IR**
...
**Next:** [Part 2: STE overview](../02-overview/02-00-overview.md). For the handbook’s one-sentence STE definition, see [What STE is and is not](../00-problem/00-07-what-ste-is-and-is-not.md). For the integrated Part 0 thesis, see [The STE thesis](../00-problem/00-08-the-ste-thesis.md).
