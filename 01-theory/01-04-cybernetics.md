...
For **governance** detail, see [Section overview (Part 6)](../06-governance/06-00-section-overview.md). For **drift** as a phenomenon **governance** must handle, see [The governance model](../06-governance/06-02-the-governance-model.md). For **validation** and **evidence**, see [Kernel reasoning surface](../07-kernel/07-05-kernel-reasoning-surface.md). For **rules** as explicit criteria, see [Rule activation](../10-ai-interface/10-02-rule-activation.md) and related artifact and kernel chapters.
...
Part 0’s **governed reasoning** chapter is a close neighbor: [Governed reasoning](../00-problem/00-05-governed-reasoning.md). For **deterministic** versus judgment-shaped assessment, see [Deterministic versus stochastic systems](../00-problem/00-06-deterministic-vs-stochastic-systems.md).
