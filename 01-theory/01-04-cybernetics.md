...
For **governance** detail, see [governance](../06-governance/06-06-governance.md). For **drift** as a phenomenon **governance** must handle, see [drift](../06-governance/06-03-drift.md). For **validation** and **evidence**, see [validation](../07-kernel/07-03-validation.md). For **rules** as explicit criteria, see material in intent and kernel parts as those chapters develop. Links may point at skeletal chapters; they still orient the reader.
