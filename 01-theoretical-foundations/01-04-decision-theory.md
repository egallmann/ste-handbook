...
### Proportionality without evasion
...
STE does not require expected-value calculations for every feature. It does not ask teams to assign numeric probabilities in **ADRs** unless they find that genuinely helpful.

Decision theory does not tell you what your **constraints** should be. Ethics, regulation, and product vision live outside this chapter.

Also, not every engineering choice deserves the same ceremony. STE encourages proportionality. The point is not maximal paperwork. The point is that **decisions** with expensive reversal costs deserve durable records and explicit **governance** when reversed.
...
### Relationship to control and information vocabulary (cross-links inside Part 1)
