...
For **invariants** as an intent surface, see [Invariants](../03-artifact-layer/03-03-invariants.md). For **constraints**, see [Requirements and constraints](../03-artifact-layer/03-02-requirements-and-constraints.md). For **validation** and **evidence**, see [validation](../06-kernel/06-03-validation.md) and [runtime evidence](../06-kernel/06-06-runtime-evidence.md). For **governance** of exceptions, see [governance](../10-lifecycle-governance/10-06-governance.md). For continuous loop framing, see [the control loop](../07-control-loop/07-01-the-control-loop.md). Targets may be skeletal; links are directional.
