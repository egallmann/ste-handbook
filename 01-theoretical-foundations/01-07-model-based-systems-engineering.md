...
**Compilation.** **MBSE** tools generate reports and views from models. STE uses **compilation** from **intent** artifacts to **Architecture IR** as a engineering operation that should be repeatable and inspectable.
...
### Practical guidance for teams with MBSE experience
...
### Integration with agile delivery rhythms
...
STE is not claiming certification equivalence to safety-critical systems engineering programs. STE is not claiming that **Architecture IR** replaces all requirements tools. STE is not claiming **MBSE** tools are unnecessary or sufficient.

Also, models can be wrong. Model-first discipline does not guarantee correctness. It improves inspectability and change safety, which is different.

Finally, **MBSE** success often depends on role clarity: who owns the model, who may edit relationships, who certifies analyses. STE has the same organizational dependency. **Architecture IR** without ownership becomes a haunted house: everybody reads it, nobody fixes it.

## Relationship to STE system

### Information and decision lenses (Part 1 cross-links)

[Information theory](01-03-information-theory.md) explains why model-centric approaches reduce ambiguous reconstruction: stable identities and explicit relationships lower **entropy**. [Decision theory](01-04-decision-theory.md) explains why models must link to **ADRs** and **governance**: structural edges without **decision** rationale still leave “why” under-specified. **MBSE** culture often insists on both structure and rationale; STE names them in handbook vocabulary.
