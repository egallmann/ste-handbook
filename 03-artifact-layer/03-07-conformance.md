...
- Part 5: [Conformance](../06-kernel/06-07-conformance.md), [Validation](../06-kernel/06-03-validation.md), [The admission model](../06-kernel/06-02-the-admission-model.md) for kernel-oriented depth.
